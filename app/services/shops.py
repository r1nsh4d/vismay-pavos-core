...
def serialize_shop(shop: Shop) -> dict:
    return {
        ...
        "contactPerson": shop.contact_person,
        "contactNumber": shop.contact_number,
        "phone": shop.phone,
        "address": shop.address or {},
        "isActive": shop.is_active,
        "isEbo": shop.is_ebo,
        "districtId": str(shop.district_id),
        "districtName": shop.district.name if shop.district else None,
        "stateId": str(shop.district.state_id) if shop.district else None,
        "stateName": shop.district.state.name if shop.district and shop.district.state else None,
        "talukId": str(shop.taluk_id) if shop.taluk_id else None,
        "talukName": shop.taluk.name if shop.taluk else None,
        "createdAt": shop.created_at.isoformat(),
        "updatedAt": shop.updated_at.isoformat(),
    }